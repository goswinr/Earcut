...
// Profiling mode: REFINE_PROFILE=1 loops refine() only (no earcut, no quality pass) so a
// flame graph is ~all refine. reset() restores earcut output between reps and shows as a
// small, clearly-labeled copy loop.
